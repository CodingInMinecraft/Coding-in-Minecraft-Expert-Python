...
View the code in the mage below.  

![alt text](https://expertpy.codingcredentials.com/Lesson11/11.1/11.8.jpg?raw=true  "Errors")

Copy the code into the workspace and fix the errors. 

There are 5 errors on lines 2, 4, 5, 9, and 10. 
