# Expert Coding using Python - Lesson 11 Activity 5
### @explicitHints true
...
View the image of the code below.  There are 2 syntax errors. 
![alt text](https://expertpy.codingcredentials.com/Lesson11/11.1/11.5.jpg?raw=true  "Syntax Error")

The first one is on line 6 and the second on line 9.  Find the errors. 
Then retype the code below and run it.
