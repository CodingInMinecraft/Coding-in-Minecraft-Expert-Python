...
*Note: You may see the examples use global when defining a variable. 
A global variable is a variable that is created outside of any function, and it can be used anywhere in your code, including inside functions.
Think of it like a shared scoreboard that every part of your program can see and update.
In this example, the global build, score line tells Python to use and update the global versions of these variables inside the function.
